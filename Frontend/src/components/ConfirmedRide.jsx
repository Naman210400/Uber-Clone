const ConfirmedRide = ({ handleCreateRide, handleCloseModal, book }) => {
  return (
    <div>
      <h5
      ...
      <div className="flex gap-2 justify-between items-center flex-col">
        ...
        <div className="w-full mt-5">
          <div className="flex items-center gap-5 p-3 border-b-2">
            ...
            <div>
              <h3 className="text-lg font-medium">{book.from}</h3>
          ...
          <div className="flex items-center gap-5 p-3 border-b-2">
            ...
            <div>
              <h3 className="text-lg font-medium">{book.to}</h3>
              {/* <p className="text-sm -mt-1 text-gray-600">Ahmedabad, India</p> */}
            </div>
          </div>
